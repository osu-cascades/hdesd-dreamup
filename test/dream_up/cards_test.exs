defmodule DreamUp.CardsTest do
  ...
  describe "cards" do
    ...
    @valid_attrs %{prompt: "some prompt", type: "some type"}
    @update_attrs %{prompt: "some updated prompt", type: "some updated type"}
    @invalid_attrs %{prompt: nil, type: nil}
    ...
    test "create_card/1 with valid data creates a card" do
      ...
      assert card.prompt == "some prompt"
    ...
    test "update_card/2 with valid data updates the card" do
      ...
      assert card.prompt == "some updated prompt"
